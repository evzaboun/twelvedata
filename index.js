...
module.exports = (config) => {
  ...
  return {
    ...
    cryptocurrencies: utilities.createFunc("cryptocurrencies", requestTypes.get),
    cryptocurrencyExchanges: utilities.createFunc("cryptocurrencyExchanges", requestTypes.get),
    earliestTimestamp: utilities.createFunc("earliestTimestamp", requestTypes.get),
    ...
    technicalIndicators: utilities.createFunc("technicalIndicators", requestTypes.get),
